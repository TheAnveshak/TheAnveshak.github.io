...
* **Bachelor of Chemical Engineering** (Minor: Artificial Intelligence & Machine Learning)  
  ...
  * **CGPA:** 8.23 / 10  
  * **Undergraduate Research Thesis:** *Valorization of CO\\(_2\\) to lower olefins via One-Pot Bifunctional Catalysis* (Advisor: Prof. G. D. Yadav)
...
======
* **Gas-Inducing Impeller Design Competition (Jan 2026):** Secured 1st place among 7 teams at Tinkerer's Lab, ICT Mumbai; fabricated a 92 mm impeller delivering an efficiency of \\(1.02 \times 10^{-5} mol L^{-1} s^{-1} W^{-1}\\).
